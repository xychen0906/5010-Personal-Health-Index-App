...
app.layout = html.Div(
    ...
    html.Div(children=[
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.H6('In nutritional therapy, it is recommended that the amount of dietary purines should be less than 400 mg per day.',style={'font-size': '20px','color': '#52C0EA'}),
                html.Div([
                    'Food',
                    dcc.Dropdown(
                        id='food',
    ...
    html.Div([
        dbc.Card(
            dbc.CardBody([
                 html.H4("Health News - About Hyperuricemia", className="card-title", style={'font-size': '30px','color': '#015792'}),
    ...
    html.Div([
        dbc.Card(
            dbc.CardBody([
                 html.H4("Health Article - About Hyperuricemia", className="card-title", style={'font-size': '30px','color': '#015792'}),
                ...
                dbc.CardLink("Article link", href="https://www.sciencedirect.com/science/article/pii/S016752731530317X"),
            ]),
        ),
    ]),
]),
